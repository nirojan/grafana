...
The [List Metrics API](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html) is used to load metrics for custom namespaces in the CloudWatch data source. By default the page limit is 500.
